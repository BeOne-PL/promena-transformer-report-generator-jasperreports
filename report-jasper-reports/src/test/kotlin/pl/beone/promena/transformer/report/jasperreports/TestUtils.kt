...
import pl.beone.promena.transformer.report.jasperreports.util.getResourceAsBytes
import kotlin.reflect.KClass

private val simpleAllParametersAndFieldsBytes = getResourceAsBytes("/template/simple-all-parameters-and-fields.jrxml")

internal fun memoryTest(parameters: Parameters, assertParametersLine: String, assertRecordLines: List<String>) {
    test(
...
internal fun fileTest(parameters: Parameters, assertParametersLine: String, assertRecordLines: List<String>) {
...
private fun test(
    ...
    JasperReportsReportTransformer(communicationParameters)
