...
object JasperReportsReportSupport {
    ...
    object ParametersSupport {
        fun isSupported(parameters: Parameters) {
            ...
            parameters.validate(JasperReportsReportParametersConstants.Parameters.NAME, JasperReportsReportParametersConstants.Parameters.CLASS, false)
        }
